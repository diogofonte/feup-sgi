    ...
    constructor() {
        ...
        */
        ...
        this.descriptors["torus"] = [
            {name: "radius", type: "float"},
            {name: "tube", type: "float"},
			{name: "radialSegments", type: "integer"},
            {name: "tubularSegments", type: "integer"},
        ...
        this.primitiveIds = ["cylinder", "ring", "rectangle", "triangle", "circle", "lathe", "torus", "sphere", "nurbs" , "box", "model3d", "skybox", "lod", "polygon" ]
    }
